            ...
            <div className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                {filteredCreditNoteInvoices.map((creditInvoice) => (
                    <div
                        ...
                        className={`flex border-b dark:bg-gray-800 dark:border-gray-700 ${selectedCreditNote === creditInvoice ? 'bg-gray-100 dark:bg-gray-700' : ''
                            }`}
                    >
                        ...
                        <div className="flex-none w-1/3 px-6 py-4">${creditInvoice.amount} {creditInvoice.currency}</div>
                        <div className="flex-none w-1/4 px-6 py-4">{creditInvoice.reference}</div>
                    </div>
                ))}
            </div>
        </div>
